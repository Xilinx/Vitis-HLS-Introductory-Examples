...
# ##################################################
open_component -reset component_static_struct_with_array_RAM -flow_target vivado
...
set_directive_reset test ts.A
set_directive_reset test ts.B
set_directive_reset test ts.C
# End of directives
