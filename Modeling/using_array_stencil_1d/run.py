...
client.set_workspace(path='./work_stencil_1d')

# Delete the component if it already exists
if os.path.exists('./work_stencil_1d/stencil_1d'):
...
cfg_file = client.get_config_file(path = './work_stencil_1d/stencil_1d/hls_config.cfg')
